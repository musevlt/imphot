# -*- coding: utf-8 -*-
#
# Muse Analysis documentation build configuration file, created by
# sphinx-quickstart on Wed Aug 24 11:58:44 2016.
#
...
project = u'Muse Analysis'
copyright = u'2016, Muse Team'
author = u'Muse Team'
...
#html_title = u'Muse Analysis v1.0'
...
htmlhelp_basename = 'MuseAnalysisdoc'
...
latex_documents = [
    (master_doc, 'MuseAnalysis.tex', u'Muse Analysis Documentation',
     u'Muse Team', 'manual'),
]
